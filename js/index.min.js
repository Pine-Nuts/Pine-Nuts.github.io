...
$(function () {
    (function () {
        ...
        $('.W-time').hover(function () {
            $(this).css({'animation': 'runs 0.5s linear', '-o-animation': 'runs 0.5s linear', '-webkit-animation': 'runs 0.5s linear', '-ms-animation': 'runs 0.5s linear', '-moz-animation': 'runs 0.5s linear'});
            $('.W-zhuan')
                .stop(true, true)
                .fadeIn(200)
        }, function () {
            $(this).css({'animation': 'runn 0.5s linear', '-o-animation': 'runn 0.5s linear', '-webkit-animation': 'runn 0.5s linear', '-moz-animation': 'runn 0.5s linear', '-msanimation': 'runn 0.5s linear'});
            $('.W-zhuan')
                .stop(true, true)
                .fadeOut(700)
        });
        ...
        function xuanz2(n, top) {
            $('.W-tim-ul li')
                ...
                .eq(n)
                .stop()
                .animate({'border-width': '2px', 'right': '-14px', 'top': top})
        };
        $('.W-lian-bottom')
            .find('a')
            .hover(function () {
        ...
        if (url == "img/WS3.jpg") {
            $('.Ws-tou')
                .find('img')
                .attr('src', 'img/me2.jpg')
        } else {
            $('.Ws-tou')
                .find('img')
                .attr('src', 'img/me1.jpg')
        }
        var Wjn = [
            {
                "color": "#1abc9c",
        ...
        $('.Ws-tu')
            ...
            .each(function (index) {
                ...
                $(this)
                    .find('.Ws-ph .Ws-ph-f')
                    .css('background', Wjn[index].color);
                $(this)
                    .find('.Ws-ph .Ws-ph-f')
